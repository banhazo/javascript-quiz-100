...
let calcAvg = prompt("국어,수학, 영어 점수를 띄어서 입력해주세요", "");
...
let num2 = prompt("숫자 2개를 공백으로 구분하여 입력해주세요");
let num2Array = num2.split(" ");
function divide() {
  let result1 = parseInt(num2Array[0] / num2Array[1]);
  let result2 = num2Array[0] % num2Array[1];
